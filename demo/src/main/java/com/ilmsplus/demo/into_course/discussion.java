...
import com.ilmsplus.demo.FinalAsyncHttpClient;
...
public class discussion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.dic_layout, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final TextView header = (TextView) getActivity().findViewById(R.id.dic_head_head);
        final TextView name = (TextView) getActivity().findViewById(R.id.dic_head);
        final TextView content = (TextView) getActivity().findViewById(R.id.dic_content);
        final TextView description = (TextView) getActivity().findViewById(R.id.dic_description);
        header.setText(" 討論區");
        header.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_compare_arrows_black_24dp,0,0,0);
